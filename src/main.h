...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 JOC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 JOC mininput
/** No amount larger than this (in satoshi) is valid */
//sum.blockchain
//max money set to a billion
static const int64 MAX_MONEY = 1000000000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
//sum.blockchain
//number of blocks which need to be mined before spending the mined balance. It is set to 30 (10+20)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
//sum.blockchain
//Johnoliver coin difficulty period is set to 1 day
//There are 144 times 10mins occurs in a day (1440 minutes = 24 hours) 
//10mins is the time set for each block to be mined (@ main.cpp around ln# 1090) 
